...
print bands_data_norm

### Plot

#bands_data_mod1 = np.roll(bands_data, 0, axis=2)
#bands_data_mod2 = np.roll(bands_data, 1, axis=2)
#bands_data_mod3 = np.roll(bands_data, 2, axis=2)

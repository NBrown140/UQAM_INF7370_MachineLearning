...
The goal was to experiment with pixel-wise classification of buildings vs non-buildings in aerial imagery (30 cm resolution) from training and test polygons created by Open Street Map (OSM). Some of the code was inspired/modified from https://github.com/machinalis/satimg.
